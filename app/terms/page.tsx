      ...
      <main className="flex-1 pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose max-w-none space-y-8">
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-slate-900 text-slate-900">1. Acceptance of Terms</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-slate-900 text-slate-900">4. Subscription and Payments</h2>
              <p className="text-slate-600 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-slate-900">5. Acceptable Use</h2>
              <p className="text-slate-600 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-slate-900">7. AI-Generated Content</h2>
              <p className="text-slate-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-slate-900">8. Disclaimer of Warranties</h2>
              <p className="text-slate-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-slate-900">9. Limitation of Liability</h2>
              <p className="text-slate-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-slate-900">10. Indemnification</h2>
              <p className="text-slate-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-slate-900">11. Modifications to Terms</h2>
              <p className="text-slate-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-slate-900">12. Governing Law</h2>
              <p className="text-slate-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-slate-900">13. Contact Us</h2>
              <p className="text-slate-600 leading-relaxed">
                If you have any questions about these Terms of Service, please contact us at:
              </p>
              <p className="text-slate-600 mt-4">
                Email: <a href="mailto:legal@docusprint.app" className="text-blue-600 hover:underline">legal@docusprint.app</a><br />
                Instagram: <a href="https://instagram.com/mr__hamdan__official" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">@mr__hamdan__official</a>
              </p>
            </section>
          </div>
        </div>
